      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="relative overflow-hidden rounded-xl bg-[#1e295b] p-6 sm:p-10 shadow-xl border border-slate-700/50">
          <div className="flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-12">
            ...
            {/* Right Section: Heading + Desk Message + Social Icons */}
            <div className="flex flex-col justify-start text-left text-white pt-2 md:pt-4 flex-1">
              ...
              {/* Center Aligned Social Icons Below Text */}
              <div className="mt-8 flex items-center justify-center gap-4">
                ...
                {inchargeData.linkedin && (
                  <a
                    ...
                    className="flex h-10 w-10 items-center justify-center rounded-full bg-white/10 text-white transition-all duration-200 hover:bg-[#0A66C2] hover:scale-110"
                ...
                {inchargeData.email && (
                  <a
                    ...
                    className="flex h-10 w-10 items-center justify-center rounded-full bg-white/10 text-white transition-all duration-200 hover:bg-red-500 hover:scale-110"
